...
void createLineArrays() {
    ...
    if (arrayId >= 0)
        wallLineArray = arrayId;
    xsArraySetInt(wallLineArray, 0, 117);
    xsArraySetInt(wallLineArray, 1, 155);
    
    arrayId = xsArrayCreateInt(3, -1, "Tower Line");
    if (arrayId >= 0)
        towerLineArray = arrayId;
    xsArraySetInt(towerLineArray, 0, 79);
    xsArraySetInt(towerLineArray, 1, 234);
    xsArraySetInt(towerLineArray, 2, 235);
